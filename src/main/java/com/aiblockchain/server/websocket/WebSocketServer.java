...
/**
 * The AI blockchain system first calls intializeAIBlockChainListenerClient to
 * create the singleton listener object and to inject a dependency for its API
 * adapter.
 * 
 * Then the system constructs the WebSocketServer instance with the API port
 * number. This constructor does not return until the application is terminated,
 * so the system uses a separate dedicated thread for that purpose.
 * 
 * @author Athi, reed
 */
public final class WebSocketServer {
	...
	/**
	 * Initialize the AI blockchain listener client from the software agent
	 * system.
	 * 
	 * @param apiAdapter
	 *            the API adapter supplied by the software agent system
	 */
